...
* Images do not contain date/time information[s], and the names are random[/s]. This cannot be altered by JavaScript and thus cannot be modified solely with this Greasemonkey script. Try the Linux Python script for those advanced features.
